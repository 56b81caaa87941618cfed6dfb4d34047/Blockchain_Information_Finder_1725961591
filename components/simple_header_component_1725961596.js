            ...
            <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-6 mx-auto">
                ...
                <div id="menu-toggle-button" class="flex items-center lg:order-2">
                    <button
                        ...
                        type="button"
                        class="inline-flex items-center p-2 ml-1 text-sm text-pink-200 rounded-lg lg:hidden hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-pink-300 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
